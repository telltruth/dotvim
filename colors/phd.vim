...
exe 'hi Comment        ctermfg=022 guifg='.s:greyed            .' guibg='.s:bg        .' gui=none'
...
exe 'hi String         ctermfg=242 guifg='.s:constant2        .' guibg='.s:bg        .' gui=none'
exe 'hi Special        ctermfg=165 guifg='.s:constant3        .' guibg='.s:bg        .' gui=none'
...
exe 'hi Type           ctermfg=166 guifg='.s:yellow            .' guibg='.s:bg        .' gui=none'
